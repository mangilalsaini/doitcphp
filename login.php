...
<head>
    ...
    <!-- code for change logo or image in tatile bar -->
    <link rel="shortcut icon" href="assets/images/business_favcon.png" type="image/x-icon">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <!-------------------------->
                                    <form class="user" method="POST" action="loginvalidate.php" >
